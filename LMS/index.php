...
<body>
	...
	<div class="container">
		...
		<div class="register">
           ...
           <option value="Sr.HighSchool">Sr.HighSchool</option>
			...
			<br>
			<p><input type="checkbox">By creating an account, you agree to our <a class="underline" href="terms1.html">Terms</a></p>
			<div class="clear"></div>
	...
	<div class="footer w3layouts agileits">
		<p> &copy; 2023 LMS Login. Nirasha Silva </a></p>
...
echo header("Location:librarian/index.php");
 ...
 { echo "<script'>alert('Failed to Login! Incorrect IDNo or Password')</script>";
}
